...
var regular = preload("res://Placeholder Textures for Shards of the Past/old_scientist.png")
var highlighted = preload("res://Placeholder Textures for Shards of the Past/old_scientist_highlighted.png")
